        ...
        fetch(process.env.REACT_APP_API_BASEURL + `/api/codes/service-modifier?${objToQueryString(data)}`, requestOptions)
            .then(async response => {
                ...
                if (!response.ok) {
                    ...
                    setServiceModifiersData(data.data);
                }
                            ...
                            <div className="row">
                                ...
                                <div className="col-md-6 mb-2">
                                    <div className="form-group">
                                        <small>Code</small>
                                        <input type="text" name="" id="" className="form-control" {...register("code", { required: true, maxLength: 2 })} />
...
function ServiceModifierRow(props) {
    return (
        <>
            <tr>
                <td>{props.s_row.service_modifier}</td>
                <td>{props.s_row.description}</td>
            </tr>
        </>
    );
}
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-2">
                                    <div class="form-group">
                                        ...
                                        {errors.service_modifier_code && errors.service_modifier_code.type === "required" && <span className="notvalid">This is required</span>}
                                        {errors.service_modifier_code && errors.service_modifier_code.type === "maxLength" && <span className="notvalid">Max length exceeded</span>}
                                    </div>
                                </div>
                                <div class="col-md-12 mb-2">
                                    <div class="form-group">

...
export default function ServiceType() {
    ...
    const fillServiceTypeData = (fdata) => {
        var arr = [
        ...
        fetch(process.env.REACT_APP_API_BASEURL + `/api/codes/service-type?${objToQueryString(fdata)}`, requestOptions)
            .then(async response => {
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="" id="" {...register("service_type_code", { required: true, maxLength: 2 })} />
                                        {/* {errors.service_type_code && <span><p className='notvalid'>This field is required</p></span>} */}
                                        {errors.service_type_code && errors.service_type_code.type === "required" && <span className="notvalid">This is required</span>}
                                        {errors.service_type_code && errors.service_type_code.type === "maxLength" && <span className="notvalid">Max length exceeded</span>}
                                    </div>
                                </div>
                                <div class="col-md-12 mb-2">
                                    <div class="form-group">

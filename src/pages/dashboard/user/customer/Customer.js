...
function Customer() {
    ...
    return (
        <>
            ...
            <CustomerForm formData={customer} adding={adding} selected={customer} />
            ...
            <form onSubmit={handleSubmit(addCode)} >
                <div class="data">
                    <div class="nav nav-tabs" id="nav-tab" role="tablist">
                        ...
                        <button class="nav-link" id="nav-profile-tab" data-bs-toggle="tab" data-bs-target="#charges" type="button" role="tab" aria-controls="nav-profile" aria-selected="false">ExceptionLits/Charges</button>
...
function Cutomer(props) {
    return (
        <>
            <tr onClick={() => props.getCustomer(props.customer.customer_id)}>

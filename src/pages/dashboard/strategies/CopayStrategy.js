    ...
    return (
        <>
            ...
            <div className="col-md-3 ms-auto text-end">
                    ...
                    Copay Strategy Strategy <i className="fa fa-plus-circle"></i></button>
            </div>
            ...
            <CopayStrategyForm  show={show} adding={adding} handleClose={handleClose} selected={benifitsData} />
                                    ...
                                    <div style={{ height: '400px', overflowY: 'scroll' }}>
                                        <table className="table table-striped table-bordered" style={{ position: 'relative' }}>
                                            <thead className='stickt-thead'>
                                                <tr>
                                                    <th>Copay Strategy ID</th>
                                                    <th>Copay Strategy Name</th>
                                                </tr>
                                            </thead>
                                            <tbody>
...
function CopayStrategyForm(props) {
    ...
    const addCode = (data) => {
        ...
        if (process.env.REACT_APP_API_BASEURL == 'NOT') {
            ...
            fetch(process.env.REACT_APP_API_BASEURL + `/api/validationlist/copay/add`, requestOptions)
                .then(async response => {
                    const isJson = response.headers.get('content-type')?.includes('application/json');
                    const data = isJson && await response.json();
                    // console.log(response);
    ...
    useEffect(() => {
        ...
        if (props.adding) {
            reset({ copay_strategy_id: '',pricing_strategy_name:'',pharm_type_variation_ind:'',network_part_variation_ind:'',claim_type_variation_ind:'',plan_accum_deduct_id:'',formulary_variation_ind:'',price_schedule:'',mac_list:'', new: 1 }, {
                keepValues: false,
            })
        } else {
        ...
        <div className="card mt-3 mb-3">
                <div className="card-body">
                    <div className="col-md-12">
                        <h5 className="mb-2">Copay Strategy Identification</h5>
                    </div>
                    <div className="row mb-2">
                        <div className="col-md-6 mb-3">
                            <div className="form-group">
                                <small> Strategy ID: </small>
                                <input type="text" name="copay_strategy_id" {...register('copay_strategy_id',{
                                    required:true,
                                })}  className="form-control" />
                           {errors.copay_strategy_id && <span><p role="alert" className="notvalid">This field is required</p></span>}
                        ...
                        <div className="col-md-6 mb-3">
                            <div className="form-group">
                                ...
                                <input type="text" name="copay_strategy_name" {...register('copay_strategy_name',{
                                    required:true,
                                })}  className="form-control" />
                             {errors.copay_strategy_name && <span><p role="alert" className="notvalid">This field is required</p></span>}

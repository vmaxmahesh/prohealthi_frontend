...
import ProviderSearchProvider,{} from './pages/dashboard/user/provider/ProviderSearchProvider';
    ...
    <>
      ...
      <Routes>
        ...
        <Route path="/dashboard" element={<Dashboard />}>
          ...
          <Route path='user/provider/superprovider' element={<ProviderSearchProvider  />}>
          {/* <Route index element={<Navigate to="network" replace />} /> */}
